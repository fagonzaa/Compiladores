package iic2322.tools.CLI;

import java.util.Vector;

/**
 * A generic command-line interface for iic2322 compilers.  This class
...
public class CLI
{
    ...
    public static final int ANALIZE = 6;

    public static final int SYMTABLE = 7;
    /**
